...
public class MainFrame extends javax.swing.JFrame implements Runnable {
    ...
    */
    ...
    private void connectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connectButtonActionPerformed
        // TODO add your handling code here:
        isClient = true; //set the isClient to true in order to enter in initializaClientMode
    ...
    public void run()
    {
        while(!isClosed) //run application until the user closes it.
        {
            ...
            if(isClient) //if the connect button was pressed, then the application is trying to connect to the server
            {
    ...
    public void disconnect()
    {
        try
        {
            ...
            if(isClient)
            {
                ...
                isClient = false;  //no more in the client mode
            }
        }
        catch(Exception e)
        {
